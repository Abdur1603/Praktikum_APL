...
int jml_pelanggan = 6, jml_paket = 3, menu_utama, menu_tambah, menu_ubah, menu_lihat, menu_hapus, idx;
string pelanggan[50] = {"Rahman", "5000/bulan", "Adi", "10.000/bulan", "ifnu", "20.000/bulan"};
string paket[50] = {"5000/bulan", "10.000/bulan", "20.000/bulan"};
string keluar = "n";
void tekan_enter()
{
