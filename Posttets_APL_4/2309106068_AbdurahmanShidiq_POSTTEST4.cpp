...
void tampil_pelanggan()
{
    ...
    {
        cout << i + 1 << ".\tNama Pelanggan: " << pelanggan[i].nama << endl;
        cout << "\tJenis Paket: " << pelanggan[i].jenis_paket << endl
             << endl;
    }
}
...
string tambah_pelanggan()
{
    try
    {
        ...
        while (true)
        {
            ...
            cin.ignore();
            getline(cin, pelanggan[jml_pelanggan].nama);
            system("cls");
            cout << "Nama Pelanggan: " << pelanggan[jml_pelanggan].nama << endl;
            ...
            {
                pelanggan[jml_pelanggan].jenis_paket = paket[pilih_paket - 1].jenis;
                jml_pelanggan++;
                break;
            }
            else
