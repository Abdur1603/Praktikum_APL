...
void tampil_paket()
{
    ...
    {
        cout << i + 1 << ". " << paket[i].harga << "/bulan." << endl;
    }
}
...
void bubblesort_angka_descending(Pelanggan *arr, int n)
{
    Pelanggan swap;
    int i, j;
    for (i = 0; i < n; i++)
...
void sequentialsearch_huruf_ascending(Pelanggan *data, string nama)
{
    ...
    for (int i = 0; i < jml_pelanggan; i++)
    {
        if (data[i].nama == nama)
        {
            cout << "nama ditemukan di index ke-" << i << endl;
        }
        else
        {
            cout << "nama tidak ada di index ke-" << i << endl;
        }
    }
}

void sequentialsearch_huruf_descending(Pelanggan *data, string nama)
{
...
string tambah_paket()
{
    ...
    cin.ignore();
    paket[jml_paket].harga = cek_number(paket[jml_paket].harga);
    jml_paket++;
...
string ubah_paket()
{
    while (true)
    {
        ...
        if (idx >= 1 && idx <= jml_paket)
        {
            ...
            cin.ignore();
            paket[idx - 1].harga = cek_number(paket[idx - 1].harga);
        }
                    ...
                    while (true)
                    {
                        ...
                        else if (menu_lihat == 2)
                        {
                            while (true)
                            {
                                ...
                                {
                                    bubblesort_angka_descending(pelanggan, jml_pelanggan);
                                    tampil_pelanggan_ptr(pelanggan);
                                    tekan_enter();
                                }
                ...
                else if (menu_utama == 5)
                {
                    while (true)
                    {
                        ...
                        cout << "Menu Searching Data:\n"
                             << "----------------\n"
                             << "1. Berdasarkan huruf ascending\n"
                             << "2. Berdasarkan huruf descending\n"
                             << "3. Kembali\n"
                             << "Masukkan pilihan: ";
                        menu_searching = cek_number(menu_searching);
                        if (menu_searching == 1)
                        {
                            sequentialsearch_huruf_ascending(pelanggan, nama);
                            tekan_enter();
                        }
                        else if (menu_searching == 2)
                        {
                            sequentialsearch_huruf_descending(pelanggan, nama);
                            tekan_enter();
                        }
